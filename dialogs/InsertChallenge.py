...
class InsertChallenge(InterruptDialog):
    challenges = {
    ...
    def __init__(self, dialog_id: str = None):
        super(InsertChallenge, self).__init__(
            dialog_id or InsertChallenge.__name__
        )
    ...
    async def second_step(self, step_context: WaterfallStepContext) -> DialogTurnResult:
            ...
            reply = MessageFactory.text("Bene, ti chiedo di fornirmi il nome della nuova challenge")
            step_context.dialogs.__setattr__("typeChallenge",intent)
    ...
    async def third_step(self, step_context: WaterfallStepContext) -> DialogTurnResult:
        name_challenge = step_context.result
        reply = MessageFactory.text("Quali sono le best_practice per affrontare questa challenge?")
        step_context.dialogs.__setattr__("nameChallenge", name_challenge)
    ...
    async def fourth_step(self, step_context: WaterfallStepContext) -> DialogTurnResult:
        ...
        name_challenge = step_context.dialogs.__getattribute__("nameChallenge")
        BestPracticesDialog.challenges.__setitem__(name_challenge,best_practices)
        dialog = step_context.dialogs.find_dialog(BestPracticesDialog.__name__)
        type_challenge = step_context.dialogs.__getattribute__("typeChallenge")
        if(type_challenge == "DevelopmentChallenges"):
            BestPracticesDialog.developmentChallenges.append(name_challenge)
