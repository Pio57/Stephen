...
class BestPracticesDialog(InterruptDialog):
    challenges = {
        ...
        "BP_N": "Una soluzione è costruire strategicamente, cioè identifichiamo un obbiettivo specifico di ciascun bot, in modo da evitare che un agente faccia tantissime cose, e strutturare le iterazioni intorno all'azione che desideri che l'utente intraprenda.",
        ...
        "BP_TLA": "Di solito un bot offre agli utenti contenuti informativi e interessanti, per divulgare ciò sicuramente le informazioni saranno tante e conviene inviare più messaggi brevi anziché uno lungo.",
